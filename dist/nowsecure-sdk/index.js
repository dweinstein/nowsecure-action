...
var _SDKReportClient_client, _SDKReportClient_apiUrl;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.convertToSarif = exports.SDKReportClient = exports.USER_AGENT = void 0;
...
class SDKReportClient {
    constructor(apiUrl) {
        _SDKReportClient_client.set(this, void 0);
        _SDKReportClient_apiUrl.set(this, void 0);
        __classPrivateFieldSet(this, _SDKReportClient_client, new http.HttpClient(exports.USER_AGENT, undefined, {
            allowRetries: true,
            maxRetries: 3,
            headers: {
        ...
        __classPrivateFieldSet(this, _SDKReportClient_apiUrl, apiUrl, "f");
    }
    issues(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            const r = yield __classPrivateFieldGet(this, _SDKReportClient_client, "f").getJson(`${__classPrivateFieldGet(this, _SDKReportClient_apiUrl, "f")}/projects/${projectId}/issues`);
            if (r.statusCode !== 200) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const projectId = core.getInput("project_id") || "3deca90e-b097-4c1d-94d3-46ad5d1abb30";
        const apiUrl = core.getInput("api_url") || "http://localhost:8080";
        const client = new SDKReportClient(apiUrl);
...
function convertToSarif(data) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const issue of data) {
            let markdown = "";
            const issueSummary = description(issue);
            const tags = [];
            if (issue.type) {
                tags.push(issue.type);
            }
            if (issue.algorithm) {
                tags.push(issue.algorithm);
            }
            if (issue.transport) {
                tags.push(issue.transport);
            }
            rules.push({
        ...
        const run = {
            tool: {
                driver: {
                    name: "NowSecure SDK",
                    informationUri: "https://www.nowsecure.com/sdk",
